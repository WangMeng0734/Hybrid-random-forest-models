function [trainedClassifier, validationAccuracy,validationPredictions,validationScores] = Train_SVM(trainingData, responseData,K,T,Ker,Box)
%% SVM支持向量机
%% 采用高斯核函数
%% 可优化超参数包括核尺度Ker(0.001~1000)和框约束Box(0.001~1000)
